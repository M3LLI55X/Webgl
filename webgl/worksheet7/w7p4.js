...
var modelViewMatrixLoc, projection, typicalMatrLocat, texLoc, reflectLoc, eyeLoc;
...
function loadNormalMapTexture(gl) {
    ...
    gl.uniform1i(gl.getUniformLocation(gl.program, "bumpMap"), 1);
...
var render = function () {
    ...
    reflectLoc = gl.getUniformLocation(gl.program, "reflective");
